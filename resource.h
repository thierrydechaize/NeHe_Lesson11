 ...
 *
 * \file            resource.h
 * \author          Created by Thierry Dechaize to verify paradigm : one source for multiple C/C++ free Compilers
 * \version         1.0.1.2
...
#define VER_PRODUCTNAME_STR 		"Lesson11 OpenGL : Wave texturing with file BITMAP.\0"
